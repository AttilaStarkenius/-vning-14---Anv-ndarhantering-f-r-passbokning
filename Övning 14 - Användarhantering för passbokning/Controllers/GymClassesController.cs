...
using Övning_14___Användarhantering_för_passbokning.Data;
using Övning_14___Användarhantering_för_passbokning.Models;

namespace Övning_14___Användarhantering_för_passbokning.Controllers
{
    public class GymClassesController : Controller
    {
        ...
        {
            gymClass.Duration = TimeSpan.Parse(gymClass.Duration.ToString());
